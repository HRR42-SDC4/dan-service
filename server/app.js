...
const client = new cassandra.Client({ contactPoints: ['localhost', 'ec2-13-57-211-243.us-west-1.compute.amazonaws.com:3005'], localDataCenter: 'datacenter1', keyspace: 'zagat' });
